...
/* =========================================================
 * STM32WB55 ON-CHIP DATA
 * ========================================================= */

/*
 * 40050 / PDU 50:
 * MCU internal temperature, C x 10
 *
 * Ornek:
 * 253 -> 25.3 C
 */
#define BMS_REG_MCU_TEMPERATURE_X10       50U

/*
 * 40051 / PDU 51:
 * Temperature sensor raw ADC value
 */
#define BMS_REG_MCU_TEMPERATURE_RAW       51U

/*
 * 40052 / PDU 52:
 * VDDA supply voltage in millivolts
 */
#define BMS_REG_VDDA_MV                   52U

/*
 * 40053 / PDU 53:
 * Uptime in seconds.
 *
 * 16-bit oldugu icin 65535 sonrasinda
 * tekrar 0'dan baslar.
 */
#define BMS_REG_UPTIME_SECONDS             53U
 ...
 * 0 = adres/deger gecersiz
 *
 * Register 129 ve 154 icin ozel validation vardir.
 * BMS_REG_COUNT altindaki diger registerlar emulator
 * ve runtime veri guncellemesi icin yazilabilir.
 */
